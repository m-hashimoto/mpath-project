...
static __inline int IICBUS_INTR(device_t dev, int event, char *buf)
{
	...
	return ((iicbus_intr_t *) _m)(dev, event, buf);
}
...
static __inline int IICBUS_CALLBACK(device_t dev, int index, caddr_t data)
{
	...
	return ((iicbus_callback_t *) _m)(dev, index, data);
}
                                          ...
                                          int timeout)
{
	...
	return ((iicbus_repeated_start_t *) _m)(dev, slave, timeout);
}
...
static __inline int IICBUS_START(device_t dev, u_char slave, int timeout)
{
	...
	return ((iicbus_start_t *) _m)(dev, slave, timeout);
}
                                ...
                                int last, int delay)
{
	...
	return ((iicbus_read_t *) _m)(dev, buf, len, bytes, last, delay);
}
                                 ...
                                 int *bytes, int timeout)
{
	...
	return ((iicbus_write_t *) _m)(dev, buf, len, bytes, timeout);
}
                                 ...
                                 u_char *oldaddr)
{
	...
	return ((iicbus_reset_t *) _m)(dev, speed, addr, oldaddr);
}
                                    ...
                                    uint32_t nmsgs)
{
	...
	return ((iicbus_transfer_t *) _m)(dev, msgs, nmsgs);
}
